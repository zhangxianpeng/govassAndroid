...
public class NewIOSAlertDialog {
    ...
    public NewIOSAlertDialog(Context context) {
    ...
    public NewIOSAlertDialog builder() {
     ...
     * @return
     */
    public NewIOSAlertDialog setGone() {
        if (lLayout_bg != null) {
     ...
     * @return
     */
    public NewIOSAlertDialog setTitle(String title) {
        showTitle = true;
     ...
     * @return
     */
    public NewIOSAlertDialog setMsg(String msg) {
        showMsg = true;
     ...
     * @return
     */
    public NewIOSAlertDialog setCancelable(boolean cancel) {
     ...
     * @return
     */
    public NewIOSAlertDialog setPositiveButton(String text,
                                               final View.OnClickListener listener) {
        return setPositiveButton(text, -1, listener);
    }

    public NewIOSAlertDialog setPositiveButton(String text, int color,
                                               final View.OnClickListener listener) {
        showPosBtn = true;
        if ("".equals(text)) {
            btn_pos.setText("");
    ...
    public NewIOSAlertDialog setNegativeButton(String text,
                                               final View.OnClickListener listener) {

        return setNegativeButton(text, -1, listener);
    }

    public NewIOSAlertDialog setNegativeButton(String text, int color,
                                               final View.OnClickListener listener) {
        showNegBtn = true;
        if ("".equals(text)) {
            btn_neg.setText("");
