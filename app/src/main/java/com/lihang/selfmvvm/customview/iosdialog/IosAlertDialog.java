...
public class IosAlertDialog {
    ...
    public IosAlertDialog builder() {
        ...
        et_group_name = view.findViewById(R.id.et_goup_name);
        et_remark = view.findViewById(R.id.et_goup_name_remark);
...
//		        .getWidth() * 0.5), LayoutParams.WRAP_CONTENT));
    ...
    public String getGroupName() {
        return et_group_name.getText().toString();
    }

    public String getGroupNameRemark() {
    ...
    public void setEditTextVisible(boolean isShowEdit) {
        et_remark.setVisibility(isShowEdit ? View.VISIBLE : View.GONE);
    }
}
