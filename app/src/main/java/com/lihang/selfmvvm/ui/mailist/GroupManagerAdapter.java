...
public class GroupManagerAdapter extends RecyclerView.Adapter<GroupManagerAdapter.MyViewHolder> implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    private List<GroupDetailsResVo> groupResVoList;
    private static final String TAG = "MemberManagerAdapter";

    private GroupManagerAdapter.OnItemClickListener mOnItemClickListener;
    private GroupManagerAdapter.OnItemCheckedListener onItemCheckedListener;

    //两次点击按钮的最小间隔，目前为1000
    private static final int MIN_CLICK_DELAY_TIME = 1000;
    private long lastClickTime;

    public GroupManagerAdapter(Context context, List<GroupDetailsResVo> groupResVoList) {
        this.context = context;
        this.groupResVoList = groupResVoList;
    }

    @Override
    public GroupManagerAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.membermanage_list_item, parent, false);
        GroupManagerAdapter.MyViewHolder viewHolder = new GroupManagerAdapter.MyViewHolder(view);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(GroupManagerAdapter.MyViewHolder holder, final int position) {
    ...
    public void setOnItemChenedListener(GroupManagerAdapter.OnItemCheckedListener listener) {
    ...
    public void setOnItemClickListener(GroupManagerAdapter.OnItemClickListener listener) {
